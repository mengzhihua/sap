...
CREATE TABLE IF NOT EXISTS sap_posting_period (id BIGINT AUTO_INCREMENT PRIMARY KEY, bukrs VARCHAR(16) NOT NULL, fiscal_year INT NOT NULL, from_period INT NOT NULL, to_period INT NOT NULL, open INT NOT NULL DEFAULT 1);
