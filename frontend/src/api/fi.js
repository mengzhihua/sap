...
export const fiApi = {
  ...
  postingPeriods: () => http.get('/fi/posting-periods'),
  savePostingPeriod: (data) => http.post('/fi/posting-periods', data),
  deletePostingPeriod: (id) => http.delete(`/fi/posting-periods/${id}`),
